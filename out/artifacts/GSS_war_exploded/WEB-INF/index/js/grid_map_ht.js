function get_window_1() {
    var window_1="" +
        ...
        "    <form  id='marker_form' method='post' onsubmit='return false' action='##'><input  type='text'     name='point' id='point' style='display:none' />\n" +
        ...
        "            <textarea id='title' name='title' placeholder='标记点名称'   from='marker_form'  style='width:180px; height:20px;padding:10px 10px; border:1px #999999 solid; font-size:16px; color:#fff; background-color:rgba(31,27,24,0.7);OVERFLOW:   hidden;'></textarea>\n" +
        ...
        "        </div>\n" +
        "        <div style='width:300px; margin:15px auto; text-align: center'>\n" +
        "            <textarea name='note' placeholder='备注信息'  cols='40'   from='marker_form' style='width:250px; height:250px;padding:0px 10px; border:1px #999999 solid; font-size:14px; color:#fff; background-color:rgba(31,27,24,0.7);OVERFLOW:   hidden;'></textarea> </div>\n" +
        "        <div style='float: left;margin: 20px 20px 20px 140px;width: 40px;height: 25px;'>\n" +
        "            <input type='button' onclick='addmarker_()' from='marker' style='background:#078be4; color:#FFF; font-size:14px; font-family:Microsoft YaHei;' value='添&nbsp;&nbsp;&nbsp;&nbsp;加'/> </div>\n" +
...
function get_window_2() {
    var window_2="" +
        ...
        "    <form  id='marker' method='post' onsubmit='return false' action='##'>\n" +
        "        <div style='width:300px; margin:15px auto; text-align: center'>\n" +
